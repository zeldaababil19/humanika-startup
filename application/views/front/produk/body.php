			...
			<div class="row">
				...
				<div class="col-sm-6" align="left">
					...
					if (empty($produk->foto)) {
						echo "<img class='img-thumbnail' src='" . base_url() . "assets/images/no_image_thumb.png' width='300' height='300'>";
					} else {
						echo "
					...
					<p>Harga: Rp <strike><b>Rp <?php echo number_format($produk->harga_normal) ?></b></strike> | <b>Rp <?php echo number_format($produk->harga_diskon) ?></b>
						<font style="font-size:15px"><span class="badge badge-pill badge-primary"><?php echo $produk->diskon ?>% OFF</span></font>
					</p>
					<p>Stok: <?php if ($produk->stok > 0) {
								...
								<div class="card mb-4 box-shadow">
									<a href="<?php echo base_url("produk/$lainnya->slug_produk ") ?>">
										...
										if (empty($lainnya->foto)) {
											...
											echo " <img class='card-img-top' src='" . base_url() . "assets/images/produk/" . $lainnya->foto . '_thumb' . $lainnya->foto_type . "'> ";
										}
										?>
									</a>
									<div class="card-body">
