<div id='cssmenu' class="align-center">
  ...
  <ul>
    ...
    <!-- <li class='active'><a href='<?= base_url('blog/paymentway') ?>'><i class=""></i>
        <font size="0.3px">Cara Bayar</font>
      </a>
    ...
    <li>
      <a href="#">
        ...
        <input class="form-control mr-md-5" type="text" name="cari" size="70" placeholder="Produk |">
        <?php echo form_close() ?>
      </a>
    </li>
    <?php
    ...
    ?>
      <li><a href="#"><i class="fa fa-shopping-cart"></i>(<?php echo $total_cart_navbar ?>)</a></li>
    <?php
    } else {
    ?>
      <li><a href="<?php echo base_url('cart') ?>"><i class="fa fa-shopping-cart"></i>(<?php echo $total_cart_navbar ?>)</a></li>
    <?php
    }
    ?>
    ...
    <?php } else { ?>
      <li><a href="<?php echo base_url('auth/register') ?>"></i> Daftar | Masuk</a></li>
    <?php } ?>
  </ul>
</div>
<br>